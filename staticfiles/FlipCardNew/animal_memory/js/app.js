...
function initGame() {
   ...
   for(i=0;i<numCards;i++) {
        document.querySelector('.deck').innerHTML += `<li class="card"><img src="static/FlipCardNew/animal_memory/img/animal/${possibleCards[i]}.svg"/></li>`;
   };
...
function congrats() {
  ...
  setTimeout(function(){
      ...
      `
        ...
        <img src="static/FlipCardNew/animal_memory/img/animal/${finishImg[numStars-1]}.svg" alt="" width="300">
      `
